import { DependencyType, type Project } from 'projen'
import { PROJEN_VERSION } from '../projen'
 ...
 */
export const syncProjenVersions = (subProjects: Project[], projenVersion: string = DEFAULT_PROJEN_VERSION) => {
