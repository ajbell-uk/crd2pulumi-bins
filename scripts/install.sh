...
PACKAGE_NAME="crd2pulumi"
PACKAGE_VERSION="1.5.4"

# Base URL for downloading binaries
BASE_URL="https://github.com/pulumi/${PACKAGE_NAME}/releases/download/v${PACKAGE_VERSION}"
...
BIN_NAME="${PACKAGE_NAME}-v${PACKAGE_VERSION}-${os}-${arch}"
